...
(function ($) {
  ...
  $.extend($.validator, {
    ...
    messages: {
      ...
      maxlength: $.validator.format("{0}자 이하를 입력해주세요."),
      minlength: $.validator.format("{0}자 이상을 입력해주세요."),
      rangelength: $.validator.format("Please enter a value between {0} and {1} characters long."),
      range: $.validator.format("Please enter a value between {0} and {1}."),
      max: $.validator.format("{0}보다 작거나 같게 선택해주세요."),
      min: $.validator.format("{0}보다 크거나 같게 선택해주세요."),
    },
