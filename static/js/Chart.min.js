...
!(function (t, e) {
  ...
  Object.defineProperty(K.prototype, "animationObject", {
    ...
    z._set("global", {
      animation: { duration: 1e3, easing: "easeOutQuart", onProgress: V.noop, onComplete: V.noop },
    });
  var $ = {
      animations: [],
      request: null,
      ...
      advance: function () {
        for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
          (e = (t = a[r]).chart),
            ...
            t.currentStep >= n
              ? (V.callback(t.onAnimationComplete, [t], e), (e.animating = !1), a.splice(r, 1))
              : ++r;
      },
    },
    J = V.options.resolve,
  ...
  function oi(t, e) {
    ...
    return (
      ...
      null !== o
        ? +o
        : (a || "function" != typeof r || ((o = r(e)), V.isFinite(o) || (o = n.parse(o))), o)
    );
  }
  function si(t, e) {
  ...
  var Ii = X.extend({
    ...
    fit: function () {
      ...
      n.display
        ? ((t =
            (V.isArray(n.text) ? n.text.length : 1) * V.options._parseFont(n).lineHeight +
            2 * n.padding),
